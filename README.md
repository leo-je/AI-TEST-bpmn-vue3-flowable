...
## 项目简介
基于[Vue3.x](https://v3.vuejs.org/guide/introduction.html) + [Vite](https://vitejs.dev/) +[ bpmn-js](https://bpmn.io/toolkit/bpmn-js/) + [element-plus](https://element-plus.gitee.io/#/zh-CN) + tsx 实现的Flowable流程设计器
...
- **resources**
  ...
  定义此了flowable的moddle的Json,用于扩展bpmn适配flowable,提供给modeler使用
